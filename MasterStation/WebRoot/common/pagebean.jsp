			...
			<s:iterator value="pageBean">
				<table border="0" cellpadding="0" cellspacing="0">
					<tbody>
						<tr>
							<td>
								<select class="pagination-page-list" name="pageList" onchange="pageList1.submit();">
							...
							<td>
								...
								<a onclick="pageList1.goToPage(1);"
							...
							<td>
								<s:if test="CurrentPage>1">
								<a onclick="pageList1.goToPage(${CurrentPage-1 })"
							...
							<td>
								...
								<s:else>
								<a onclick="pageList1.goToPage(${TotalPage})"
							...
							<td>
								<a onclick="pageList1.goToPage(${CurrentPage})" class="pagination-load-btn p-plain"><span
...
<script>
	...
	var pageList1 = {};
	pageList1.goToPage = function(page){
		$("#page").val(page);
		$("form")[0].submit();
	};
	pageList1.submit = function(){
		$("form")[0].submit();
	};
</script>