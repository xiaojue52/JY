...
<html>
	...
	<body>
					...
					<font size="5" face="楷体_GB2312"><strong>历史数据</strong></font>
					</span>
			       </div>
			       <div><s:form action="listHistory.action">设备名称：<input type="text" name="sqlDeviceHistoryColumn.name"/>所属网柜：<input type="text" name="sqlDeviceHistoryColumn.deviceBox"/><input type="submit" value="查询"/></s:form></div>
