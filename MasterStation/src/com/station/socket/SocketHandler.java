...
public class SocketHandler {
	...
	private Map<String, Socket> clientMap = Collections
			.synchronizedMap(new HashMap<String, Socket>());// 当前连接的设备
	private Map<String, Map<String, String>> orderMap = Collections
			.synchronizedMap(new HashMap<String, Map<String, String>>());// 主站启用的设备
	 ...
	 */
	public SocketHandler(JYSocketService socketService,
			JYTimerTaskService chartDataService) {
	...
	private void init(String cabId, Socket client, String phoneNumber) {
		...
		order.put("heartBeat",
				Constant.getDateStr(new Date(), "yyyyMMddHHmmss"));
	...
	public void parseTempData(String str, Socket client) {
		...
		// Mes =
		// "2000000|#000000|20131206124730|0001+1235+0135+1240+0103*0002+2356+1111+0104+1432|XCR";
	 ...
	 */
	/*
	 * public void parseHeartBeat(String str, Socket client) { // Mes =
	 * "4000000|#000000|XCR"; // Ret = "4100000|#000000|0XCR"; String command[]
	 * = str.split("[|]"); if (command != null && command.length == 3 &&
	 * command[0].length() == 7) {
	 * this.storeHeartBertOrder(command[1].substring(0, 5)); String tempStr =
	 * "4100000|" + command[1] + "|0XCR"; this.sendCommand(tempStr, client);
	 * return; } String tempStr = "4100000|" + command[1] + "|1XCR";
	 * this.sendCommand(tempStr, client); }
	 */
	 ...
	 * 
	 * Map<String, String> order = orderMap.get(cabId); order.put("heartBeat",
	 * Constant.getDateStr(new Date(),"yyyyMMddHHmmss")); orderMap.put(cabId,
	 * order); this.socketService.updateCabinetStatus(cabId); }
	 */
	/**
	 * 设置上传温度数据周期
	 * 
	...
	public List<String> sendCommandToGetTempWithCabIdList(String[] cabIdList) {
		...
		// Ret =
		// "1100000|#000000|20131206124730|0001+1235+0135+1240+0103*0002+2356+1111+0104+1432|0XCR"
		Date date = new Date();
