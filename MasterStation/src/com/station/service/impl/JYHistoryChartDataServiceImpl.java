...
public class JYHistoryChartDataServiceImpl implements JYHistoryChartDataService {
	...
	public PageBean getPerPage(int countPerpage, int currentPage, String hql) {
		...
		int TotalCount=historyChartDataDAO.getTotalCount(hql);//总记录数		
		...
		List<JYHistoryChartData> list= historyChartDataDAO.getPerPage(hql, startRow, CountPerpage);//该页显示的记录
	...
	public int getTotalCount(String hql) {
		// TODO Auto-generated method stub
		return historyChartDataDAO.getTotalCount(hql);
	}
}
