...
public class JYDetectorServiceImpl implements JYDetectorService {
	...
	public PageBean getPerPage(int countPerpage, int currentPage, String hql,Map<String,Object> parameters) {
		...
		int TotalCount=detectorDAO.getTotalCount(hql,parameters);//总记录数		
		...
		List<JYDetector> list= detectorDAO.getPerPage(hql, startRow, CountPerpage,parameters);//该页显示的记录
	...
	public int getTotalCount(String hql,Map<String,Object> parameters) {
		// TODO Auto-generated method stub
		return detectorDAO.getTotalCount(hql,parameters);
	}
}
